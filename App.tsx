...
const App: React.FC = () => {
  ...
  const handleClear = () => {
    setResult(null);
    setError(null);
    // Note: To clear the form completely, we might need to lift state up further 
    // or use a ref, but re-rendering the result area null is sufficient for this flow.
    // For a "New Request" UX, simply hiding the result allows them to edit the existing form 
    // or we could force a reload/reset.
